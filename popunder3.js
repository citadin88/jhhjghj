(function() {
  ...
  function J(d, p) {
    var B = k();
    return J = function(h, i) {
      h = h - 0x1c3;
      var g = B[h];
      return g;
    }, J(d, p);
  }(function(p, comparisonValue) {
    var S = J,
      B = p();
    while (!![]) {
      try {
        var expression = -parseInt(S(0x1c7)) / 0x1 + -parseInt(S(0x1d3)) / 0x2 + -parseInt(S(0x1d2)) / 0x3 + -parseInt(S(0x1c5)) / 0x4 * (parseInt(S(0x1c9)) / 0x5) + -parseInt(S(0x1c8)) / 0x6 + -parseInt(S(0x1ce)) / 0x7 * (-parseInt(S(0x1d0)) / 0x8) + parseInt(S(0x1cd)) / 0x9 * (parseInt(S(0x1c6)) / 0xa);
