(function(e, d, r) {
    ...
    var x = {
        ...
        _openAd: function(a, b) {
            ...
            var f;
            "popunder" == c ? f = this._openPopunder(a, b.crtimeout || this.settings.crtimeout, b.prefetchurls || []) : "popup" == c ? f = this._openPopup(a, b.prefetchurls || []) : "tabup" == c ? f = this._openTabup(a, b.prefetchurls || []) : "tabunder" == c && (f = this._openTabunder(a, b.prefetchurls || []));
            if (!1 !== f)
                try {
                    if (b.onafteropen instanceof Function)
                        b.onafteropen(a);
    ...
    var K = {
        ...
        _preparePopDefault: function() {
            ...
            if (!1 === this._config._default || "" == this._config._default || 0 < this._config._defaultPerDay && this._getFiredCount("fallback") >= this._config._defaultPerDay)
                ...
                if ("function" === typeof this._config._default) {
                    ...
                    /^https?:\/\//.test(c) && (setTimeout(function() {
                        x.addUrl(c, {
                            type: b,
                    ...
                    .bind(a), this._mSecondsTillDelayExpired()),
                    ...
                    try {
                        ...
                        "string" === typeof f && (d.body.appendChild(d.createRange().createContextualFragment(f)),
                        this._updateFiredCount("fallback"),
                        this.adfired = !0)
                    } catch (g) {}
            }
        ...
        _waitForGoodWeather: function() {
            top != e && 0 == e.outerWidth && 0 == e.outerHeight && 0 == e.innerWidth && 0 == e.innerWidth || d.hidden ? setTimeout(this._waitForGoodWeather.bind(this), 50) : (setTimeout(this._init.bind(this), this._mSecondsTillDelayExpired()),
